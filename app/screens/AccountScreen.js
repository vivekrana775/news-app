...
import { SET_NAME, SET_USERNAME, isAuthorized } from "../store/action";
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mid_section}>
          ...
          >
            ...
            />
            <Text style={{ fontSize: 20, fontWeight: "700" }}>Home Screen</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.yourBlogs}>
            <Image
